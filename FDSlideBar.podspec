...
Pod::Spec.new do |s|
  ...
  s.name         = "FDSlideBar"
  s.version      = "0.0.1"
  s.summary      = "A custom slide bar like the top slide menu of NTES news client used in iOS."
  ...
  s.homepage     = "https://github.com/fergusding/FDSlideBar"
  ...
  s.source       = { :git => "https://github.com/fergusding/FDSlideBar.git", :tag => "0.0.1" }
